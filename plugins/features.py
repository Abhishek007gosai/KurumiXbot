...
async def top_anime_command(client: Client, message: Message):
    try:
        ...
        keyboard.extend([
            [InlineKeyboardButton("• ᴏᴡɴᴇʀ ", url='t.me/EternalsHelplineBot'),
             InlineKeyboardButton(" ᴍᴏʀᴇ •", url='t.me/AnimeNexusNetwork/158')],
    ...
    try:
        ...
        await message.reply(
            (
                f"❌ ᴇʀʀᴏʀ ᴏᴄᴄᴜʀᴇᴅ:\n\n"
                f"ʀᴇᴀsᴏɴ: {e}\n\n"
                f"📩 ᴄᴏɴᴛᴀᴄᴛ ᴅᴇᴠᴇʟᴏᴘᴇʀ: [ᴏᴡɴᴇʀ](https://t.me/EternalsHelplineBot)"
            ),
            reply_markup=reply_markup
        )
...
@Bot.on_message(filters.command('addpremium') & filters.private & filters.user(OWNER_ID))
...
@Bot.on_message(filters.command('remove_premium') & filters.private & filters.user(OWNER_ID))
...
@Bot.on_message(filters.command('premium_users') & filters.private & filters.user(OWNER_ID))
...
@Bot.on_message(filters.command("count") & filters.private & filters.user(OWNER_ID))
