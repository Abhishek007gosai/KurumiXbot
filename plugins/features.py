...
@Bot.on_message(filters.command('addpremium') & filters.private & is_admin)
...
@Bot.on_message(filters.command('remove_premium') & filters.private & is_admin)
...
@Bot.on_message(filters.command('premium_users') & filters.private & is_admin)
...
@Bot.on_message(filters.command("count") & filters.private & is_admin)
